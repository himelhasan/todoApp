  ...
  return (
    <>
      <div className="md:w-[90%] mx-auto mb-3 ">
        <div className="w-full inline-flex items-center bg-white leading-none rounded-full p-2 pl-4 shadow text-teal text-sm group/edit">
          ...
          <span className="text-lg inline-flex px-2 text-gray-700">
            Im a sexy badge and you can use me everyday at every hour. Im a sexy badge and
            you can use me everyday at every hour.
          </span>
      ...
      >
        ...
        <Modal.Body>
          <Textarea color="secondary" bordered labelPlaceholder="Write a comment" />
        </Modal.Body>
        <Modal.Footer>
