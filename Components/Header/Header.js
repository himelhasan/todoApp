          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-slate-700  focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? "bg-gray-900 text-white" : "text-slate-700 ",
              ...
              {user ? (
                <>
                  <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    >
                      <Bars3Icon
                        className="block h-6 w-6 text-white mx-2"
                        aria-hidden="true"
                      />
                    </label>
                  </div>
                ...
                <>
                  ...
                  <Link
                    href="/login"
                    className="text-slate-700  px-3 py-2 rounded-md text-sm font-medium"
                    aria-label="Login"
                    title="Login"
                  >
                    Login
